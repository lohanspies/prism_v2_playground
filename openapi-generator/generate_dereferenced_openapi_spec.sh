...
# Example: 
#
#   openapi-generator-cli generate -i http://localhost:8090/prism-agent/api/openapi-spec.yaml -g openapi-yaml -o ./derereferenced_openapi yml --auth apiKey:<url encoded token>
