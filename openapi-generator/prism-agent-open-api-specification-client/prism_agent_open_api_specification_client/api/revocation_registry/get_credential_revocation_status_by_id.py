...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[W3CCredentialStatus]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[W3CCredentialStatus]:
    return Response(
