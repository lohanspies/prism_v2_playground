...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[RevocationStatus]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[RevocationStatus]:
    return Response(
