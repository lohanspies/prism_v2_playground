...
class CredentialSchemaResponse:
    ...
    Attributes:
        guid (str): Globally unique id of the credential schema. It's composed
        ...
        id (str): A locally unique identifier to address the schema. UUID is
        ...
        description (str): A human-readable description of the credential schema Example: Simple credential schema for
            the driving licence verifiable credential. This field is not a part of W3C specification.
        ...
        schema (CredentialSchemaResponseSchema): Valid JSON Schema where the Credential Schema data fields are defined
        ...
        long_id (Union[Unset, str]): Resource id of the credential schema. Contains the `author`'s DID, `id` and
            `version` fields. Example: did:prism:4a5b5cf0a513e83b598bbea25cd6196746747f361a73ef77068268bc9bd732ff/0527aea1-d
            131-3948-a34d-03af39aba8b4?version=1.0.0.
    ...
    description: str
    type: str
    schema: "CredentialSchemaResponseSchema"
    author: str
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        schema = CredentialSchemaResponseSchema.from_dict(d.pop("schema"))
