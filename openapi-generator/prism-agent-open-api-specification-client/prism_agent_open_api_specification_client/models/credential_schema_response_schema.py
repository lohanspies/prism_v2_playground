...
T = TypeVar("T", bound="CredentialSchemaResponseSchema")


@attr.s(auto_attribs=True)
class CredentialSchemaResponseSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        credential_schema_response_schema = cls()

        credential_schema_response_schema.additional_properties = d
        return credential_schema_response_schema
