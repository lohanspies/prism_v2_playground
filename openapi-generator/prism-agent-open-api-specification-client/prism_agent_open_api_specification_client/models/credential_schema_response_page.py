...
class CredentialSchemaResponsePage:
    ...
    Example:
        {'pageOf': '/prism-agent/schema-registry/schemas', 'next': '/prism-agent/schema-
            ...
            'contents': [{'schema': {'example': {'$id': 'driving-license-1.0', '$schema': 'https://json-
            ...
            'description': 'Simple credential schema for the driving licence verifiable credential. This field is not a part
            of W3C specification', 'longId': 'did:prism:4a5b5cf0a513e83b598bbea25cd6196746747f361a73ef77068268bc9bd732ff/052
            7aea1-d131-3948-a34d-03af39aba8b4?version=1.0.0', 'type': 'https://w3c-ccg.github.io/vc-json-
            schemas/schema/2.0/schema.json', 'version': '1.0.0', 'tags': ['driving', 'licence', 'id'], 'name':
            'DrivingLicense', 'guid': '0527aea1-d131-3948-a34d-03af39aba8b4', 'self': '/prism-agent/schema-
