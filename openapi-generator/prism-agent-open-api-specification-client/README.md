...
```python
from prism_agent_open_api_specification_client.models import MyDataModel
from prism_agent_open_api_specification_client.api.my_tag import get_my_data_model
...
1. Any endpoint which did not have a tag will be in `prism_agent_open_api_specification_client.api.default`
